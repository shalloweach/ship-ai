 ...
 */
// ========== 📦 弹窗内容构建 ==========
import { convertWGS84ToGCJ02 } from './utils'
...
export default function useMapOperation(containerRef) {
  ...
  const renderTrajectory = (points, options = {}) => {
    ...
    const [convertedLng, convertedLat] = convertWGS84ToGCJ02(points.lon, points.lat);
    points.lon = convertedLng;
    points.lat = convertedLat;
