  ...
  <fieldset class="control-card player-card">
    ...
    <div class="player-config">
      <div class="config-item">
        ...
        <input 
          id="startIndex"
          v-model.number="controller.localStartIndex" 
          type="number" 
          min="0" 
          ...
          placeholder="0"
          @change="controller.onStartIndexChange"
        />
      </div>
      ...
      <div class="config-item">
        ...
        <select 
          id="speed"
          v-model.number="controller.localSpeed" 
          @change="controller.onSpeedChange"
          class="config-select"
        >
    ...
    <div class="player-actions">
      <button 
        class="btn btn-play" 
        @click="controller.handleStartPause"
...
<script setup>
import { createPlayerController, useTrackPlayer } from './useTrackPlayer'
...
// 🔹 初始化核心播放器
const controller = useTrackPlayer(props.mmsi, props.totalCount, props.mapOp)

// 🔹 初始化组件控制器（绑定 player）
const controller = createPlayerController(props, player)
