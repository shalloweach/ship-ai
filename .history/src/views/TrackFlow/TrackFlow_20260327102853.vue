  ...
  <main class="track-flow-container" role="main" aria-label="船舶轨迹查询系统">
    ...
    <section class="map-wrapper" role="region" aria-label="轨迹地图展示">
      ...
      >
        <span aria-hidden="true">⚠️</span>
        <span>{{ error }}</span>
        <span class="close-hint" aria-hidden="true">（点击关闭）</span>
      </div>
      ...
      <!-- 🚢 MMSI 标识标签 -->
      <div class="mmsi-tag" role="note" aria-label="当前查询船舶">
        <span aria-hidden="true">🚢</span>
