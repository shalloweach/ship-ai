<template>
  <div class="track-flow">
    ...
    <!-- ✅ 关键修复：给地图容器添加 :key，MMSI 变化时强制重建 -->
    <div :id="'mapContainer-' + currentMmsi" class="map-container" ref="mapContainerRef"></div>
    ...
    <!-- ✅ 关键修复：遮罩使用 v-show 而非 v-if，避免 DOM 移除冲突 -->
...
const mapContainerRef = ref(null)  // ✅ 用 ref 获取容器，避免直接操作 DOM ID
