        ...
        <transition name="panel-fade" mode="out-in">
          ...
          >
            <MarkCard
              ...
              @start-mark-flow="handleStartMarkFlow"
              @submit="handleSubmitMarks"
              @mark-select="handleMarkSelect"
              @mark-update="handleMarkUpdate"
              @mark-reselect="handleMarkReselect"
              @mark-delete="handleMarkDelete"
              @mark-highlight="handleMarkHighlight"
              @submit-success="handleMarkSubmitSuccess"
              @submit-error="handleMarkSubmitError"
            />
          </div>
        </transition>
...
import { setCurrentMmsi } from '@/components/MarkEditDialog/markFlow'
