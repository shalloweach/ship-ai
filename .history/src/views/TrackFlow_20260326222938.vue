<template>
  <div class="track-flow">
    ...
    <TimeSlider 
      :mmsi="currentMmsi"
      :minTimestamp="defaultMinTs"
      :maxTimestamp="defaultMaxTs"
...
const totalRecords = ref(10000)  // 可后续通过接口获取真实值

// 默认时间范围（2023全年）
const defaultMinTs = 1672531200  // 2023-01-01 00:00:00 UTC
const defaultMaxTs = 1704067199  // 2023-12-31 23:59:59 UTC
